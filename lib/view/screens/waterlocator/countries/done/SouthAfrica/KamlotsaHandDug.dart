...
class KamlotsaHandDug extends StatefulWidget {
  const KamlotsaHandDug({super.key});

  @override
  State<KamlotsaHandDug> createState() => _StellamarisState();
}

class _StellamarisState extends State<KamlotsaHandDug> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/South Africa/Kamlotsa Hand dug well north south Africa.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
