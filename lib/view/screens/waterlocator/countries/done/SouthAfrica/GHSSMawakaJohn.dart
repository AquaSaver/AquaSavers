...
class GHSSMawakaJohn extends StatefulWidget {
  const GHSSMawakaJohn({super.key});

  @override
  State<GHSSMawakaJohn> createState() => _StellamarisState();
}

class _StellamarisState extends State<GHSSMawakaJohn> {
  void sendwhatsapp() {
    launchUrl(_uri);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/South Africa/GH SS Mawaka john west South Africa.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
