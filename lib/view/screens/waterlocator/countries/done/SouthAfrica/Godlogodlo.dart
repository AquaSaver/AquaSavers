...
class Godlogodlo extends StatefulWidget {
  const Godlogodlo({super.key});

  @override
  State<Godlogodlo> createState() => _StellamarisState();
}

class _StellamarisState extends State<Godlogodlo> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/South Africa/Godlogodlo east south Africa.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
