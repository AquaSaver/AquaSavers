...
class Mabinha extends StatefulWidget {
  const Mabinha({super.key});

  @override
  State<Mabinha> createState() => _StellamarisState();
}

class _StellamarisState extends State<Mabinha> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/South Africa/Mabhena south.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
