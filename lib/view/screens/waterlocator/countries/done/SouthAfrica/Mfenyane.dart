...
class Mfenyane extends StatefulWidget {
  const Mfenyane({super.key});

  @override
  State<Mfenyane> createState() => _StellamarisState();
}

class _StellamarisState extends State<Mfenyane> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/South Africa/Mfenyane water point north south Africa.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
