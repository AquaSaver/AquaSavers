...
class Mkhalafene extends StatefulWidget {
  const Mkhalafene({super.key});

  @override
  State<Mkhalafene> createState() => _StellamarisState();
}

class _StellamarisState extends State<Mkhalafene> {
  void sendwhatsapp() {
    launchUrl(_uri);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/South Africa/Mkhalafene east south Africa.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
