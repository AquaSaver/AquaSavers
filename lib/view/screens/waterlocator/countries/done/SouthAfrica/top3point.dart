...
class Toppoint extends StatefulWidget {
  const Toppoint({super.key});

  @override
  State<Toppoint> createState() => _StellamarisState();
}

class _StellamarisState extends State<Toppoint> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/South Africa/Tap 3 south south Africa.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
