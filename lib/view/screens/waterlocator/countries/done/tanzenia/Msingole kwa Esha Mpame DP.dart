...
class MsingolekwaEshaMpameDP extends StatefulWidget {
  const MsingolekwaEshaMpameDP({super.key});

  @override
  State<MsingolekwaEshaMpameDP> createState() => _MsingolekwaEshaMpameDPState();
}

class _MsingolekwaEshaMpameDPState extends State<MsingolekwaEshaMpameDP> {
  void sendemail() {
    launchUrl(_uri3);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            "Msingole kwa Esha Mpame DP Point",
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Tanzania/Msingole kwa Esha Mpame DP south Tanzania.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
