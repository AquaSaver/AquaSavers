...
class BFGataboKigwati extends StatefulWidget {
  const BFGataboKigwati({super.key});

  @override
  State<BFGataboKigwati> createState() => _BFGataboKigwatiState();
}

class _BFGataboKigwatiState extends State<BFGataboKigwati> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Tanzania/BF kwitangi 8 west Tanzania.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
