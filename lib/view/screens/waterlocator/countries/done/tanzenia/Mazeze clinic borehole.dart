...
class Mazezeclinicborehole extends StatefulWidget {
  const Mazezeclinicborehole({super.key});

  @override
  State<Mazezeclinicborehole> createState() => _MazezeclinicboreholeState();
}

class _MazezeclinicboreholeState extends State<Mazezeclinicborehole> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Tanzania/Mazeze clinic borehole east Tanzania.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
