...
class BFGatumba1 extends StatefulWidget {
  const BFGatumba1({super.key});

  @override
  State<BFGatumba1> createState() => _BFGatumba1State();
}

class _BFGatumba1State extends State<BFGatumba1> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Tanzania/BF Gatumba1 north Tanzania.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
