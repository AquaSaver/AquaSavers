...
class DPDispensaryMatala extends StatefulWidget {
  const DPDispensaryMatala({super.key});

  @override
  State<DPDispensaryMatala> createState() => _DPDispensaryMatalaState();
}

class _DPDispensaryMatalaState extends State<DPDispensaryMatala> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Tanzania/DP Dispensary Matala north Tanzania.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
