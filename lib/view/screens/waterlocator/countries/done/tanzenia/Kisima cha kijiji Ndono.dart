...
class KisimachakijijiNdono extends StatefulWidget {
  const KisimachakijijiNdono({super.key});

  @override
  State<KisimachakijijiNdono> createState() => _KisimachakijijiNdonoState();
}

class _KisimachakijijiNdonoState extends State<KisimachakijijiNdono> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Tanzania/Kisima cha kijiji Ndono north Tanzania.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
