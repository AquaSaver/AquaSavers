...
class Mavilica extends StatefulWidget {
  const Mavilica({super.key});

  @override
  State<Mavilica> createState() => _MavilicaState();
}

class _MavilicaState extends State<Mavilica> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Tanzania/Mavilica south Tanzania.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
