...
class Maquiringawest extends StatefulWidget {
  const Maquiringawest({super.key});

  @override
  State<Maquiringawest> createState() => _MaquiringawestState();
}

class _MaquiringawestState extends State<Maquiringawest> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Tanzania/Maquiringa west Tanzania.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
