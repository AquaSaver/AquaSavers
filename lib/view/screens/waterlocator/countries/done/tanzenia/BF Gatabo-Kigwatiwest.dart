...
class BFGataboKigwatiiiii extends StatefulWidget {
  const BFGataboKigwatiiiii({super.key});

  @override
  State<BFGataboKigwatiiiii> createState() => _BFGataboKigwatiiiiiState();
}

class _BFGataboKigwatiiiiiState extends State<BFGataboKigwatiiiii> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Tanzania/BF Gatabo-Kigwati west Tanzania.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
