...
class Mguzezine extends StatefulWidget {
  const Mguzezine({super.key});

  @override
  State<Mguzezine> createState() => _StellamarisState();
}

class _StellamarisState extends State<Mguzezine> {
  void sendwhatsapp() {
    launchUrl(_uri);
  }
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Hero(
                    tag: "Mguessine",
                    child: Image.network(
                        '${StoreLink.imagesitems}/Senegal/BF2 Communautè de Mbin Mody west Senegal.jpg')),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 25.0, left: 10, right: 10),
