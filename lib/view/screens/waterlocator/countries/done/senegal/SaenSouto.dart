...
class SaenSouto extends StatefulWidget {
  const SaenSouto({super.key});

  @override
  State<SaenSouto> createState() => _StellamarisState();
}

class _StellamarisState extends State<SaenSouto> {
  void sendemail() {
    launchUrl(_uri3);
  }
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Hero(
                    tag: "SaenSouto",
                    child: Image.network(
                        '${StoreLink.imagesitems}/Senegal/Bf6 du village de saensouto south Senegal.jpg')),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 25.0, left: 10, right: 10),
