...
class BFN1 extends StatefulWidget {
  const BFN1({super.key});

  @override
  State<BFN1> createState() => _StellamarisState();
}

class _StellamarisState extends State<BFN1> {
  void sendwhatsapp() {
    launchUrl(_uri);
  }
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Hero(
                    tag: "BFN1",
                    child: Image.network(
                        '${StoreLink.imagesitems}/Senegal/BF N°1 North Senegal.jpg')),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 25.0, left: 10, right: 10),
