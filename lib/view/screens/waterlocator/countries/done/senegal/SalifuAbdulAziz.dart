...
class SaifAbdulaziz extends StatefulWidget {
  const SaifAbdulaziz({super.key});

  @override
  State<SaifAbdulaziz> createState() => _StellamarisState();
}

class _StellamarisState extends State<SaifAbdulaziz> {
  void sendemail() {
    launchUrl(_uri3);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Senegal/Salifu Abdul Aziz south Senegal.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
