...
class Chitochi extends StatefulWidget {
  const Chitochi({super.key});

  @override
  State<Chitochi> createState() => _StellamarisState();
}

class _StellamarisState extends State<Chitochi> {
  void sendemail() {
    launchUrl(_uri3);
  }
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Hero(
                    tag: "Chitochi",
                    child: Image.network(
                        '${StoreLink.imagesitems}/Zambia/Chitochi community west zambia.jpg')),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 25.0, left: 10, right: 10),
