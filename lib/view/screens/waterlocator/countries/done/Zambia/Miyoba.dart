...
class Miyoba extends StatefulWidget {
  const Miyoba({super.key});

  @override
  State<Miyoba> createState() => _StellamarisState();
}

class _StellamarisState extends State<Miyoba> {
  void sendwhatsapp() {
    launchUrl(_uri);
  }
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Hero(
                    tag: "Miyoba",
                    child: Image.network(
                        '${StoreLink.imagesitems}/Zambia/east zambia miyoba protected well.jpg')),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 25.0, left: 10, right: 10),
