...
class Kimikngy extends StatefulWidget {
  const Kimikngy({super.key});

  @override
  State<Kimikngy> createState() => _StellamarisState();
}

class _StellamarisState extends State<Kimikngy> {
  void sendwhatsapp() {
    launchUrl(_uri);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Zambia/Kimikanga north zambia.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
