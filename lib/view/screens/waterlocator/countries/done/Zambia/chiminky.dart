...
class Chimini extends StatefulWidget {
  const Chimini({super.key});

  @override
  State<Chimini> createState() => _StellamarisState();
}

class _StellamarisState extends State<Chimini> {
  void sendemail() {
    launchUrl(_uri3);
  }
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Hero(
                    tag: "Chimini",
                    child: Image.network(
                        '${StoreLink.imagesitems}/Zambia/Chimini primary school borehole south zambia.jpg')),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 25.0, left: 10, right: 10),
