...
class Shabasonje extends StatefulWidget {
  const Shabasonje({super.key});

  @override
  State<Shabasonje> createState() => _StellamarisState();
}

class _StellamarisState extends State<Shabasonje> {
  void sendwhatsapp() {
    launchUrl(_uri);
  }
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Hero(
                    tag: "Shabasonje",
                    child: Image.network(
                        '${StoreLink.imagesitems}/Zambia/Shabasonje 1 east zambia .jpg')),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 25.0, left: 10, right: 10),
