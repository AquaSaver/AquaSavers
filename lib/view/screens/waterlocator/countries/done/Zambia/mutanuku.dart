...
class Mutaniki extends StatefulWidget {
  const Mutaniki({super.key});

  @override
  State<Mutaniki> createState() => _StellamarisState();
}

class _StellamarisState extends State<Mutaniki> {
  void sendwhatsapp() {
    launchUrl(_uri);
  }
          ...
          children: [
            Padding(
              ...
              child: Container(
                  ...
                  child: Image.network(
                    '${StoreLink.imagesitems}/Zambia/Mutuntutuko north zambia.jpg',
                    fit: BoxFit.cover,
                  )),
            ),
            Padding(
