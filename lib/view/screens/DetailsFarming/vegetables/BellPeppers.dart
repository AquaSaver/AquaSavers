...
class BellPeppers extends StatelessWidget {
  const BellPeppers({super.key});
            ...
            Container(
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: NetworkImage('${StoreLink.imagesitems}/organic/BellPepperBackground.jpg'),
                      fit: BoxFit.fill)),
            ),
...
importance(BuildContext context, int index) {
  final List<String> names = <String>['Vitamin A', 'Excellent source of vitamin C', 'Protect diseases as cardiovascular disease'];
...
steps(BuildContext context, int index) {
  final List<String> Stepsinfo = <String>['Plant them 18 to 24 inches apart in a sunny, well-drained spot. Pepper plants need at least 6-8 hours of sunlight per day.', 'Mix compost or other organic matter into the soil when planting.', 'Water immediately after planting, then regularly throughout the season. Aim for a total of 1-2 inches.', 'Mix a continuous-release fertilizer into the soil at planting and replenish as directed during the growing season.',"Support each pepper plant with a stake or small tomato cage, to help bear the weight of the fruit once it begins to produce.","Harvest peppers with shears or a knife, then store in the fridge. Be sure to pick all peppers before the first fall frost comes."];
  return Padding(
