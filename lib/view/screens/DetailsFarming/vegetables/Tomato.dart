            ...
            Container(
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image:NetworkImage('${StoreLink.imagesitems}/organic/TomatoItems.jpg'),
                      fit: BoxFit.fill)),
            ),
...
importance(BuildContext context, int index) {
  final List<String> names = <String>['Vitamin A', 'Protection against sunburns.', 'Especially high in lycopene.',"Fight several diseases."];
...
steps(BuildContext context, int index) {
  final List<String> Stepsinfo = <String>["Most gardeners start tomato plants from seed or buy transplants, but taking cuttings from existing tomato plants in the garden can extend the season in areas with lengthy growing periods. In May or June, cut 4- to 8-inch cuttings from unwanted side shoots on the plant.","Remove the leaves from the bottom half of the cutting and place it in water in a sunny place.","After roots have developed in three to four weeks, plant the cutting in a small pot containing well-draining garden soil or potting soil. After it is well rooted, transplant it into the garden."];
  return Padding(
