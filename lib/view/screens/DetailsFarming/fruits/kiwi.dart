            ...
            Container(
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: NetworkImage('${StoreLink.imagesitems}/organic/Kiwiback.jpg'),
                      fit: BoxFit.fill)),
            ),
...
importance(BuildContext context, int index) {
  final List<String> names = <String>['Vitamin C', 'Vitamin B6', 'Vitamin A', "Stimulates the body's immune response."];
...
steps(BuildContext context, int index) {
  final List<String> Stepsinfo = <String>['Kiwi can be grown in a wide range of soils, as long as the soil is well drained.', 'Choose a planting site that is protected from strong winds.', 'Plant 10–15’ apart.', 'Water frequently and deeply in very hot weather.'];
 return Padding(
